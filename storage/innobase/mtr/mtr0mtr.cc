...
/** Count CRC for modified pages, except free pages, and writes OPTION CHECKSUM
record */
struct WriteOptionCRC {
...
private:
  ...
  mtr_t& m_mtr;
  /** there can be several elements in mtr_t::memo which refer to the same page,
  this variable contains a set of already visited pages to avoid OPTION
